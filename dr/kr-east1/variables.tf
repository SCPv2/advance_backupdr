...
variable "postgresql_engine_id" {
  type        = string
  description = "[TERRAFORM_INFRA] PostgreSQL engine version ID (Community 16.8)"
  default     = "9fa40db8fadc47599ee6d539fa72a597"
}

variable "cachestore_engine_id" {
  type        = string
  description = "[TERRAFORM_INFRA] CacheStore engine version ID"
